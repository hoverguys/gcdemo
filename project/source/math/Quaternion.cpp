...
Matrix Quaternion::ToMatrix() const {
    return Matrix({1.0f - 2.0f * y * y - 2.0f * z * z, 2.0f * x * y + 2.0f * z * w, 2.0f * x * z - 2.0f * y * w, 0.0f,
                   2.0f * x * y - 2.0f * z * w, 1.0f - 2.0f * x * x - 2.0f * z * z, 2.0f * z * y + 2.0f * x * w, 0.0f,
                   2.0f * x * z + 2.0f * y * w, 2.0f * z * y - 2.0f * x * w, 1.0f - 2.0f * x * x - 2.0f * y * y, 0.0f});
}

Quaternion Quaternion::operator*(const Quaternion& other) const {
    return Quaternion(
        w * other.x + x * other.w - y * other.z - z * other.y, w * other.y + y * other.w - z * other.x - x * other.z,
        w * other.z + z * other.w - x * other.y - y * other.x, w * other.w - x * other.x - y * other.y - z * other.z);
}
